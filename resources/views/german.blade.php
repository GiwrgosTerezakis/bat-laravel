        ...
        <div class="main-panel">
            ...
            <button onclick="window.scrollTo({top: 0, behavior: 'smooth'});" id="ScrollToTop" title="Top">
                <svg version="1.1" id="svg_to_top" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="462.847px" height="462.847px"
                    viewBox="0 0 462.847 462.847" style="enable-background:new 0 0 462.847 462.847;"
                    xml:space="preserve">
                    <g>
                        <g>
                            <path
            ...
            <div class="content">
                <div class="col-lg-12 mid-choose-buttons">
                    <div class="col-sm-3 total-people" style="margin: 0 auto">
                        ...
                        <h3 class="card-title"><i style="bottom: 3px;
                            position: relative;" class="tim-icons text-info ">
                ...
                <div class="row" id="DemographicsCard">
                        ...
                        <div class="col-lg-6 gender-table">
                            <div class="card card-chart">
                                <div class="card-header ">
                                    ...
                                    <h2 class="card-title"
                                        style=" text-align: center;text-decoration: overline;padding: 15px;">Gender
                                        Distribution</h2>
                        ...
                        <div class="col-lg-6 gender-table-risk">
                            <div class="card card-chart">
                                <div class="card-header ">
                                    ...
                                    <ul style="list-style-type: disclosure-closed;" id="gender-risk">
                    ...
                    <div class="col-lg-12" style="display: inline-flex">
                        ...
                        <div class="col-lg-6 risk-table">
                            <div class="card card-chart">
                                <div class="card-header ">

                                    <h2 class="card-title"
                                        style=" text-align: center;text-decoration: overline;padding: 15px;">Age
                                        Distribution</h2>

                                    <ul style="list-style-type: disclosure-closed;" id="age-analysis">
                        ...
                        <div class="col-lg-6 risk-table-age">
                            <div class="card card-chart">
                                <div class="card-header ">

                                    <h2 class="card-title"
                                        style=" text-align: center;text-decoration: overline;padding: 15px;">Age | Good
                                        Risk</h2>

                                    <ul style="list-style-type: disclosure-closed;" id="age-risk">
